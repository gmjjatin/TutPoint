							...
							<div class="col-md-5 col-lg-5 col-xl-6 offset-md-3 appear-animation" data-appear-animation="fadeInLeftShorter">
								...
								<div class="card">
									<div class="card-body p-5">
										<h2 class="font-weight-bold text-center text-6 mb-0">Reset Password</h2>
										
										<form class="custom-form-style-1" action="/ResetPasswordDoneController" method="get">
											<div class="form-row">
												<div class="form-group col-md-12">
												<%session.setAttribute("resetPasswordSucces","true");%>
												<%String op=(String)session.getAttribute("oldPassword"); %>
													<p class="text-color-dark text-5 text-center">Your old password</p>													
													<input type="text" value="" data-msg-required="Please enter your new password" maxlength="50" class="form-control background-color-tertiary" placeholder="<%=op %>" >
												</div>
											...
											<div class="form-row">
												<div class="form-group col-md-12">
												<p class="text-color-dark text-5 text-center">Your New Password</p>
													<input type="text" value="" data-msg-required="Please enter your new password" maxlength="50" class="form-control background-color-tertiary" name="password" id="password" placeholder="password*" required>
												</div>
