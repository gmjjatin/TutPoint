	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
				<!--
				<section class="pagoe-header background-color-quaternary parallax" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/demos/education/parallax/parallax-4.jpg">
					<div class="container">
 ...
 %>
				...
				<form  action="<%=blobstoreService.createUploadUrl("/register")%>" method="post" enctype="multipart/form-data">
					...
					<div class="row padtop">
						...
						<div class="col-md-6">	
							<input type='file' onchange="readURL(this);"  name="picKey" />
					...
					<div class="row padtop">
						...
						<div class="col-md-5"><input type="text" maxlength="20" placeholder="*Enter new First Name" name="name"  value="<%=uname%>"></div>
						...
						<div class="col-md-5"><input type="text" maxlength="10" placeholder="*Enter new Phone no." name="phone" value="<%=uphone%>"></div>
					</div><div class="row padtop">
						<div class="col-md-2"><h5>Edit Password:</h5></div>
						<div class="col-md-5"><input type="text" maxlength="10" placeholder="*Enter new Password" name="pass" value="<%=upass%>"></div>
					
					</div><div class="row padtop">
						<div class="col-md-2"><h5>Edit E-Mail ID:</h5></div>
						<div class="col-md-5"><input type="text" maxlength="100" placeholder="*Enter new Email-ID" name="email" readonly="readonly" value="<%=uemail%>"></div>
					</div>
				<!-- 	<div class="row padtop">
				...
				<div class="container">
					<div class="row justify-content-between">
						<div class="col-lg-3 mb-4 mb-lg-0">
							...
							<p>TutPoint Education <br>New Delhi, India</p>
